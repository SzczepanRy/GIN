...
func NuserUserService(usercollection *mongo.Collection, ctx context.Context) UserService {
...
func (u *UserServiceImpl) GetUser(name *string) (*models.User, error) {
	...
	//db.collectionsnam.find({name:"name"})
...
func (u *UserServiceImpl) GetAll() ([]*models.User, error) {
	...
	cursor.Close(u.ctx)
	if len(users) == 0 {
		return nil, errors.New("documents no found")
	}
	return users, nil
}
...
func (u *UserServiceImpl) UpdateUser(user *models.User) error {
	...
	if result.MatchedCount != 1 {
		return errors.New("no mached user")
	}
	return nil
}
...
func (u *UserServiceImpl) DeleteUser(name *string) error {
	...
	if result.DeletedCount != 1 {
		return errors.New("no mached delete ")
	}
	return nil
